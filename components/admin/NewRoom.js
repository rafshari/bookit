...
import { newRoom, clearErrors } from '@/redux/actions/roomAction'
import { NEW_ROOM, NEW_ROOM_RESET } from '@/redux/constants/roomConstant'
          ...
          >
            ...
            <div className='form-check'>
              <input
                className='form-check-input'
                type='checkbox'
                id='airCondition_checkbox'
                value={airCondition}
                onChange={(e) => setAirCondition(e.target.checked)}
              />
              <label
                className='form-check-label'
                htmlFor='airCondition_checkbox'
              >
                Air Conditioned
              </label>
            </div>
