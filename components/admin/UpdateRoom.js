...
import { updateRoom, getRoom, clearErrors } from '@/redux/actions/roomAction'
import { GET_ROOM, UPDATE_ROOM } from '@/redux/constants/roomConstant'
...
const UpdateRoom = () => {
    ...
    useEffect(() => {
        ...
        if (isUpdated) {
            ...
            dispatch({ type: UPDATE_ROOM.reset})
        }
    ...
    return (
        <>
            {roomDetailsLoading.includes(GET_ROOM.pending) ? <Loader /> :
